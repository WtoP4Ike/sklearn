<h2>Раздел 1. Линейная регрессия</h2>
<ins>Линейная регрессия</ins> - это метод машинного обучения, который используется для прогнозирования НЕПРЕРЫВНОЙ ЦЕЛЕВОЙ ПЕРЕМЕННОЙ
